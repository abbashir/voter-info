              ...
              <div className="flex-1">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    {/* Highlighted and copyable ভোটার নং */}
                    <div
                      className="flex items-center gap-2 text-sm text-green-700 font-semibold cursor-pointer select-all"
                      onClick={() => navigator.clipboard.writeText(voter.voter_no)}
                      title="Click to copy ভোটার নং"
                    >
                      <FileText size={16} />
                      <span>ভোটার নং: {voter.voter_no}</span>
                    </div>
                  </div>
                </div>
